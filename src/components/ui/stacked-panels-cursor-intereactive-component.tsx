...
function Panel({
  ...
  return (
    ...
    >
      {/* Background image loaded with smooth-loader */}
      <div
        ...
        style={{
          ...
          backgroundColor: "#111", // Dark placeholder while loading
...
export default function StackedPanels() {
  ...
  useEffect(() => {
    // Initialize Smooth Loader once component is mounted
    try {
      smoothLoader('.smooth-loader', {
        rootMargin: '200px', // Pre-load slightly before coming into view
      });
    } catch (e) {
      console.warn("Smooth loader initialization skipped during SSR or failed:", e);
    }
  }, []);
